      ...
      r(".pricing-wrapper").each(function (a, o) {
        ...
        e.find(".pricing-switcher").on("click", function () {
          e.find(".pricing-switcher").toggleClass("pricing-switcher-active"),
            ...
            e.find(".card-title").removeClass("title-hidden"),
            e.find(".uil").removeClass("uil-hidden"),
            e.find(".uil").addClass("uil-check"),
            e.find(".uil").toggleClass("price-show price-hide");
            e.find(".price").toggleClass("price-show price-hide");
            e.find(".card-title").toggleClass("title-show title-hide");
  ...
  $("form").submit(function () {
      ...
      $.ajax({
          ...
          success: function (data) {
              ...
              $(formNm).html('<p style="text-align:center; font-weight: bold;"><i style="font-size: 42px;" class="uil uil-envelope-check"></i><br />'+data+'</p>');
          },
...
$(function() {
  ...
  $('.jmp__input_tel').mask('+994(00)-000-00-00');
});
